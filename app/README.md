...
- Route autocomplete is offered in PHP only — YAML route references are not detected.
- Not published to the Marketplace: `package.json` still carries a placeholder
  `publisher` ID.
