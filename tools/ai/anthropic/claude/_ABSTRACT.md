...
| [`../../../../.claude/skills/`](../../../../.claude/skills/) | Skills — one flat dir each: typescript-code-helper, cc-config-helper, git-commit-helper, vscode-extension-helper |
| [`../../../../.claude/commands/`](../../../../.claude/commands/) | Slash commands — `app/base/` typescript-code-review, `utility/claude/` code-config-review |
