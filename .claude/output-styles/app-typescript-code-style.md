---
name: app-typescript-code-style
...
Review severity mapping for these criteria: `.claude/agents/app-typescript-code-reviewer.md`.
...
> **SoT.** These are the project's type-safety criteria for both authoring and review. The
> `app-typescript-code-reviewer` agent and the `/app-typescript-code-review` command apply this
> section rather than restating it — they add only their own severity mapping and audit-only
> checks. Change a rule here and both inherit it.
