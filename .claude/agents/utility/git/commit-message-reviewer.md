...
description: "Reads ./.claude/tmp/utility/git/commit-message-draft.md and verifies Conventional Commits format, scope, and factual consistency with the diff. Invoked by the git-commit-helper skill right after the author produces a draft, and reports a PASS/REDO verdict with reasons."
model: sonnet
maxTurns: 30
