...
2. **Invoke the author**
   - Invoke the `git-commit-message-author` agent to generate `./.claude/tmp/utility/git/commit-message-draft.md`.

3. **Invoke the reviewer**
   - Invoke the `git-commit-message-reviewer` agent to generate `./.claude/tmp/utility/git/commit-message-review.md`.
